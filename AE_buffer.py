...
class AutoEncoder():
    def __init__(self, shape_data, folder='fcn_AE_models/', noise='saltPepper', name='uut_noise1'):
...
if __name__ == '__main__':
    ...
    # clean_data = torch.load('C:/Users/joaqu/Desktop/Magister/Modelo_linealizado/Autoencoder/Tanks_Data/No_Noised_Inputs/data_clean_lin.pkl') # Original data to compare with output data
